...
- Settings are saved to `~/Library/Application Support/ai-desk-pet/settings.json`.
...
`~/Library/Application Support/ai-desk-pet/characters/<id>/` and run `npm run validate -- <dir>`.
